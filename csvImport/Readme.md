...
TwoWayTripNeeded (required) - YES/NO
RiderIsVulnrable (required) - YES/NO
RiderWillNotTalkPolitics (required) - YES/NO
PleaseStayInTouch (required) - YES/NO
NeedWheelchair (required) - YES/NO
...
RiderLegalConsent (required) - YES/NO
RiderWillBeSafe (required) - YES/NO

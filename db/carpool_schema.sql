...
--
-- Name: fct_modified_column(); Type: FUNCTION; Schema: nov2016; Owner: dmilet
--
...
ALTER FUNCTION nov2016.fct_modified_column() OWNER TO dmilet;
...
CREATE TABLE match (
    ...
    last_updated_ts timestamp with time zone DEFAULT now() NOT NULL
);

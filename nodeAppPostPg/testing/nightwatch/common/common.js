...
var testObject = {
  ...
  finish: createChainableTest(function(client) {
    client.end();
  }),

  nextDate: createChainableTest(function(client) {
    testObject.currentDateIndex += 1;
  }),

  finishOrig: function(client) {
    var client = this.setClient(client);
  ...
  addDriver: createChainableTest(function(client) {
    ...
    client
      ...
      .assert.containsText('form#offer-ride legend', 'Choose your organization')
  ...
  addRider: createChainableTest(function(client) {
    var dates = testObject.dates;
    var dateIndex = testObject.currentDateIndex;
  ...
  viewDriverSelfService: createChainableTest(function(client) {
    client
      ...
      .waitForElementVisible(
        '#driverProposedMatches > #driverProposedHeader',
        3000
      )
      .assert.containsText(
        '#driverProposedMatches > #driverProposedHeader',
  ...
  viewProposedMatch: createChainableTest(function(client) {
    client.assert // to do - should check for first list item
      .containsText('#driverProposedMatches > ul li', 'UUID_driver')
      .assert.containsText(
        '#driverProposedMatches > ul li.list_button button',
        'Accept'
      )
  ...
  // this test is called after first rider, then driver have been added - it's assumed
  // app is at driver self service page, with a proposed match visible
  acceptMatch: createChainableTest(function(client) {
    client
      ...
      .waitForElementVisible(
        '#driverConfirmedMatches > ul li.list_button button',
        3000
      )
  ...
  driverCancelMatch: createChainableTest(function(client) {
    client
  ...
  viewRiderSelfService: createChainableTest(function(client) {
  ...
  pauseDriverSelfService: createChainableTest(function(client) {
    client
  ...
  // this test is called after a driver has been added - it's assumed
  // app is at driver self service page
  cancelDriverSelfService: createChainableTest(function(client) {
    client
  ...
  // this test is called after a rider has been added - it's assumed
  // app is at rider self service page
  cancelRiderSelfService: createChainableTest(function(client) {
    client
  ...
  viewRiderMatch: createChainableTest(function(client) {
    client.assert // to do - should check for first list item
      .containsText('#riderConfirmedMatch > ul li', 'UUID_driver')
      .assert.containsText(
        '#riderConfirmedMatch > ul li.list_button button',
        'Cancel'
      );
  }),

  riderCancelMatch: createChainableTest(function(client) {
    client
      .waitForElementVisible(
        '#riderConfirmedMatch > ul li.list_button button',
        1000
  ...
  matchRiderDriver: createChainableTest(function(client) {
    testObject
      .addRider(client)
      .addDriver()
  ...
  loginOperatorPage: createChainableTest(function(client) {
    client
    ...
    client
      ...
      .click('#showGetDriversList')
      .pause(3000)
      .waitForElementVisible('#hideDriversListButton', 3000)
      .click('#hideDriversListButton')
      .pause(3000)
      .waitForElementVisible('#showGetDriversList', 3000)
      .pause(3000);
  }),

  addRiderOperatorPage: createChainableTest(function(client) {
    var dates = testObject.dates;
    var dateIndex = testObject.currentDateIndex;

    console.log('addRider OpPage');
    console.log('dates: ', dates);

    client
      .url('http://10.5.0.4:4000/operator-page/#need-ride')
      .waitForElementVisible('form#need-ride', 3000)
      .assert.cssClassPresent('#RiderAvailableTimes', 'available-times')
      ...
      .click('input[name="RiderPreferredContact"]')
      .click('input[name="RiderLegalConsent"]')
      ...
      //     client.click('button[id="riderSetTestDateButton"]');
  ...
  addDriverOperatorPage: createChainableTest(function(client) {
    ...
    client
      .url('http://10.5.0.4:4000/operator-page/#offer-ride')
      .waitForElementVisible('body', 3000)
      .assert.containsText('form#offer-ride legend', 'Choose your organization')
  ...
  logoutOperatorPage: createChainableTest(function(client) {
    client
      .waitForElementVisible('#logout', 3000)
      .click('#logout')
      .pause(3000)
